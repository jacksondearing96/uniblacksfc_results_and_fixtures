// declaring colours for use in console
cReset = "\x1b[0m";
cMagenta = "\x1b[35m";
cCyan = "\x1b[36m";
cYellow = "\x1b[33m";
...
router.post('/getResults', function(req,res) 
{
  ...
  GetResultsForTeam(team, processesCompleted, res); 

}); // end getResults post request handle

async function GetResultsForTeam(team, processesCompleted, res)
{
  if (team.success_ == true)
  {
    res.send(JSON.stringify(team));
  ...
  try
  {
    ...
    {
      GetPastGameDetails(page, team, res, processesCompleted, browser);
    }
    else
    {
    ...
    if (team.lastRoundOfTheSeason_ != team.pastGame_.round_)
    {
      ...
      GetFutureGameDetails(futurePage, team, res, processesCompleted, browser);
    }
    else
    {
...
async function CheckGetResultsProgress(team, res, processesCompleted, browser)
{
...
async function GetPastGameDetails(page, team, res, processesCompleted, browser) {
  ...
  for (const pClub of pClubs) {
    ...
    if (await clubIsAUFC(page, pClub)) {
      ...
      CheckGetResultsProgress(team, res, processesCompleted, browser);
...
async function GetFutureGameDetails(page, team, res, processesCompleted, browser) 
{
  // DELETE ME
