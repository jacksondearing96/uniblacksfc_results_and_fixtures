...
class UrlGeneratorTest(unittest.TestCase):
    ...
    def test_url_code(self):
        self.assertEqual(url_generator.get_url_code(2020, "Mens", "1"), "547208")
        self.assertEqual(url_generator.get_url_code(
    ...
    def test_url_generator(self):
        self.assertEqual(url_generator.get_url(2019, "Mens", "1", 1),
                         'https://websites.sportstg.com/comp_info.cgi?c=1-114-0-510206-0&a=ROUND&round=1&pool=1')

    
    def test_url_generator(self):
        FUTURE_GAME = False
        self.assertEqual(url_generator.get_url(2019, "Mens", "1", 1, FUTURE_GAME),
